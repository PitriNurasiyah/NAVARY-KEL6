    ...
    <div class="main-content">
        <div class="header">
            <div class="welcome-text">
                <h3 class="fw-bold mb-0" style="font-family: 'Fredoka One';">Produksi Susu</h3>
                <p style="color: #6d4c41; font-weight: 600; margin-bottom: 0;">Halaman pencatatan produksi susu.</p>
            </div>
