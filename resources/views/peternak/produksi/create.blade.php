...
<body>
    ...
    @if(request('mode') != 'modal')
        ...
        @include('layouts.header', ['pageTitle' => 'Tambah Produksi', 'pageSubtitle' => 'Input data baru'])
    ...
    <div class="register-wrapper" style="{{ request('mode') != 'modal' ? 'padding-top: 20px;' : '' }}">
        <div class="farm-wrapper">
            ...
            <div class="login-box">
                ...
                <div class="title">Tambah Produksi</div>
                ...
                <form action="{{ route('produksi.store') }}" method="POST" target="_parent">
                @csrf
