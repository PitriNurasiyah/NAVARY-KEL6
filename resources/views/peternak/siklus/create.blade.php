...
<body>
    ...
    @include('layouts.header', ['pageTitle' => 'Siklus Sapi', 'pageSubtitle' => 'Tambah data siklus reproduksi'])

    <div class="main-content">
        <div class="page-title-section">
            <h3>Tambah Siklus Sapi ⏳</h3>
        </div>
        ...
        <div class="form-container">
            <form action="{{ route('siklus.store') }}" method="POST">
                ...
                <div class="mb-3">
                    <label class="form-label">Hari Ke (Opsional)</label>
                    <input type="number" name="hari_ke" class="form-control" placeholder="Contoh: 10">
                </div>
                <div class="mb-3">
                ...
                <div class="d-flex gap-2">
                    <button type="submit" class="btn btn-save">Simpan Siklus</button>
