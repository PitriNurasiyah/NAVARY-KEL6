...
<head>
    ...
    <style>
        ...
        .report-card { background: #fffcf7; padding: 30px; border-radius: 25px; border: 1.5px solid #e6d5c0; text-align: center; transition: 0.3s; display: block; text-decoration: none; color: inherit; height: 100%; box-shadow: 0 8px 20px rgba(0,0,0,0.02); }
