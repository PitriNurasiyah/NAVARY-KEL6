    ...
    @if(request('export_excel') === 'true')
        <script>
            window.addEventListener('load', function() {
                setTimeout(function() {
                    exportToExcel('dataTable', 'Laporan_Penjualan', 'LAPORAN HASIL PENJUALAN SUSU & YOGURT', 'Periode: {{ request('dari_tanggal') ? \Carbon\Carbon::parse(request('dari_tanggal'))->format('d/m/Y') : 'Semua Periode' }} - {{ request('sampai_tanggal') ? \Carbon\Carbon::parse(request('sampai_tanggal'))->format('d/m/Y') : 'Sekarang' }}', function() {
                        setTimeout(function() {
