    ...
    <div class="main-content">
        <div class="header">
            <div class="welcome-text">
                <h3 class="fw-bold mb-0" style="font-family: 'Fredoka One', cursive;">Tambah Data Sapi 🐄</h3>
                <p style="color: #6d4c41; font-weight: 600; margin-bottom: 0;">Masukkan informasi sapi baru.</p>
            </div>
        ...
        <div class="form-container">
            ...
            <form action="{{ route('sapi.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="kode_sapi" class="form-control" placeholder="Contoh: 001" value="{{ old('kode_sapi') }}" required>
                </div>
